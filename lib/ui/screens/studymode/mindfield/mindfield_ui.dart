...
import 'mindfield_noti.dart';

class MindFieldUI extends StatefulWidget {
  const MindFieldUI({super.key});

  @override
  State<MindFieldUI> createState() => _MindFieldUIState();
}

class _MindFieldUIState extends State<MindFieldUI> {
  int? selectedIndex;
  bool answered = false;
  bool right = false;
